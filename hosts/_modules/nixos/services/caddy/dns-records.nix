...
# This module exports a function that generates DNS A records from registered Caddy virtual hosts
...
# - Caddy reverse proxies use declarative zone records (this module)
{ lib, config, ... }:
with lib;
let

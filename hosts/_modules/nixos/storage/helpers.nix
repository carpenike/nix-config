...
in
{
  # Expose the helpers as a module argument for services to use
  _module.args.storageHelpers = storageHelpers;

  # No config section needed - this module only provides utilities
}

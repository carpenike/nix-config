...
in
{
  ...
  assertions = [
    {
      assertion = !f.modelPlaneReady && m.acceptedPublisherPins == null;
      message = "N03 model preparation cannot activate before accepted publisher pins and a new reviewed native assignment.";
    }
    {
  ...
  # Configuration only: current pins cannot accept the producer fields above.
  environment.etc = {

...
let
  ...
  imageCredentials = builtins.listToAttrs (map (provider: {
...
in
{
  # Evaluation-only declarations: fake identities, catalogs, providers and runtime paths.
  ...
  providerExceptions = builtins.listToAttrs (map (provider: {
